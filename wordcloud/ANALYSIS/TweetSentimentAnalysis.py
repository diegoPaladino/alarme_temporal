# inspirated by:
# https://devpost.com/software/anycountrytweetanalysis
# https://github.com/Jayaram18/CountryTweetAnalysis
...
class TweetSentimentAnalysis:
    ...
    def DownloadData(self):
        ...
        searchTerm = input("Digite o tweet listado acima, que deseja analisar: ")
        ...
        if searchTerm in trend_out: 
            ...
            print("O termo de pesquisa que você inseriu não está na lista acima")
